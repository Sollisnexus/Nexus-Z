...
class Pokemon(commands.Cog):
    ...
    async def catch(self, ctx):
        ...
        if responce.startswith(str(ctx.prefix)+'catch'):
            ...
            try:
                ...
                if Name == namea:
                    ...
                    if Name == "Mr":
                        ...
                        embed.set_thumbnail(url= "https://raw.githubusercontent.com/Sollisnexus/Nexus-Z/master/PokemonImages/Shiny/"+str(LName)+".png")
                        embed.add_field(name= "Ball Type", value=str(msg[0])+"\n"+str(msg1[0])+"\n"+str(msg2[0])+"\n"+str(msg3[0])+"\n"+str(msg4[0])+"\n"+str(msg5[0])+"\n"+str(msg6[0])+"\n"+str(msg7[0])+"\n", inline=True)
                        embed.add_field(name="Odds", value=str(msg[1])+"% - "+str(msg[2])+"%\n" + str(msg1[1])+"% - "+str(msg1[2])+"%\n" + str(msg2[1])+"% - "+str(msg2[2])+"%\n" + str(msg3[1])+"% - "+str(msg3[2])+"%\n" + str(msg4[1])+"% - "+str(msg4[2])+"%\n" + str(msg5[1])+"% - "+str(msg5[2])+"%\n" + str(msg6[1])+"% - "+str(msg6[2])+"%\n" + str(msg7[1])+"% - "+str(msg7[2])+"%\n", inline=True)
                        embed.set_footer(text="Provided by Nexus-Z", icon_url="https://raw.githubusercontent.com/Sollisnexus/Sollisnexus.github.io/master/NexusZ/NexusZLogo_2.png")
                        # await ctx.message.delete()
                ...
                if Name == namea:
                    ...
                    if GaName in Listofalola:
                            ...
                            if Ball in Ballist:
                                ...
                                embed = discord.Embed(title= "Alolan " + GaName + "'s Capture Odds", description="", color=0x2962FF)
                                embed.set_thumbnail(url= "https://raw.githubusercontent.com/Sollisnexus/Nexus-Z/master/PokemonImages/Alolan/Shiny/"+GaName+".png")
                                embed.add_field(name= "Ball Type", value=str(msg[0]), inline=True)
                                embed.add_field(name="Odds", value=str(msg[1])+"% - "+str(msg[2])+"%\n", inline=True)
                                embed.set_footer(text="Provided by Nexus-Z", icon_url="https://raw.githubusercontent.com/Sollisnexus/Sollisnexus.github.io/master/NexusZ/NexusZLogo_2.png")
                                # await ctx.message.delete()
                                await ctx.send(embed=embed)
                    ...
                    if GName in Listofgmax:
                        ...
                        if Ball in Ballist:
                            if Ball == "Heavyball":
                                ...
                                embed = discord.Embed(title= "Gmax " + GName + "'s Capture Odds", description="", color=0x2962FF)
                                embed.set_thumbnail(url= "https://raw.githubusercontent.com/Sollisnexus/Nexus-Z/master/PokemonImages/Gmax/Shiny/"+GName+".png")
                                embed.add_field(name= "Ball Type", value=str(Ball), inline=True)
                                embed.add_field(name="Odds", value=str(msg[1])+"% - "+str(msg[2])+"%\n", inline=True)
                                embed.set_footer(text="Provided by Nexus-Z", icon_url="https://raw.githubusercontent.com/Sollisnexus/Sollisnexus.github.io/master/NexusZ/NexusZLogo_2.png")
                                # await ctx.message.delete()
                                await ctx.send(embed=embed)
    ...
    async def pokedex(self, ctx):
        responce = str(ctx.message.content)
        if responce.startswith(str(ctx.prefix)+'pokedex'):
            content = responce.split()
            Name = string.capwords(content[1])
            namea = "Alolan"
            namegl = "Galarian"
            if Name == namea:
                ...
                if GaName in Listofalola:
                    ...
                    embed = discord.Embed(title= str(result[0]) + " " + Name + " " + AName + "   " + str(result[2]) , description="", color=0x2962FF)
                ...
                GlName = string.capwords(content[2])
                GlmName = string.capwords(content[2]) + " Mime"
                Listofgalar = ["Meowth","Ponyta","Rapidash","Slowpoke","Slowbro","Farfetch'str(result[3])","Weezing","Mr Mime","Articuno","Zapdos","Moltres","Slowking","Corsola","Zigzagoon","Linoone","Darumaka",
                               "Darmanitan","Yamask","Stunfisk"]
                if GlName in Listofgalar or GlmName in Listofgalar:
                    if GlName == "Mr":
                        RGName = "Mrmime"
                        result = galarianpokedex(str(RGName))
                        embed = discord.Embed(title= str(result[0]) + "   " + Name + " " + GlmName + "   " + str(result[2]) , description="", color=0x2962FF)
                        ...
                        if GlName== "Darmanitan":
                                    ...
                                    embed = discord.Embed(title= str(result[0]) + "   " + Name + " " + GlName + "   " + str(result[2]) , description="", color=0x2962FF)
                                    embed.set_thumbnail(url= "https://raw.githubusercontent.com/Sollisnexus/Nexus-Z/master/PokemonImages/Galarian/Shiny/"+GlName+".png")
                                    embed.add_field(name="Misc. info", value="Gender Ratio: \n**"+str(result[14])+"% M** / **"+str(result[15])+"% F**\nHeight/Weight: \n**"+str(result[16])+"m** / **"+str(result[17])+"kg**\nCatch Rate: **"+str(result[10])+"**\n**"+str(result[1])+"**\nEgg Groups: **\n"+str(result[18])+"\n"+str(result[19])+"**" , inline=True)
                                    embed.add_field(name="Base Stats", value="HP: **"+str(result[3])+"**\nAtk: **"+str(result[4])+"**\nDef: **"+str(result[5])+"**\nSpA: **"+str(result[6])+"**\nSpD: **"+str(result[7])+"**\nSpe: **"+str(result[8])+"**\nTotal: **"+ str(result[9]) +"**", inline=True)
                                    embed.add_field(name="Abilites", value="Ability 1: \n**" +str(result[11])+"**\nAbility 2: \n**"+str(result[12])+"**\nHidden Ability: \n**" + str(result[13]) +"**", inline=True)
                                    ...
                                    embed = discord.Embed(title= str(result[0]) + "   " + Name + " Darmanitan Zen Mode   " + str(result[2]) , description="", color=0x2962FF)
                            ...
                            result = galarianpokedex(str(GlName))
                            if GlName == "Farfetch'str(result[3])":
                                w = "Farfetchd"
                                embed = discord.Embed(title= str(result[0]) + "   " + Name + " " + GlName + "   " + str(result[2]) , description="", color=0x2962FF)
    ...
    async def natures(self, ctx):
        responce = str(ctx.message.content)
        if responce.startswith(str(ctx.prefix)+"natures"):
    ...
    async def ball(self, ctx):
        responce = str(ctx.message.content)
        if responce.startswith(str(ctx.prefix)+'ball'):
            content = responce.split()
            ...
            if res == True:
                ...
                if Den == "Farfetch'd" or Gnm == "Mr":
                    if Den =="Farfetch'd":
                        ...
                        embed.add_field(name="Sword:", value="Non-HA: "+str(result[0])+"\nHA: "+ str(result[2]), inline=False)
                        embed.add_field(name="Shield:", value="Non-HA: " + str(result[1]) + "\nHA: "+ str(result[3]), inline=False)
                        embed.set_footer(text="Provided by Nexus-Z", icon_url="https://raw.githubusercontent.com/Sollisnexus/Sollisnexus.github.io/master/NexusZ/NexusZLogo_2.png")
                        # await ctx.message.delete()
                        await ctx.send(embed=embed)
                    elif Gnm == "Mr":
...
def main(pokename, ballType):
    ...
    fileOpen = open('C:/Users/Administrator/Documents/bulbapedia_data.csv', newline='')
...
def alolanmain(pokename, ballType):
    ...
    fileOpen = open('C:/Users/Administrator/Documents/Alolan.csv', newline='')
    fileData = csv.reader(fileOpen)
    for row in fileData:
        for name in row:
            if name == pokename:
...
def galarianmain(pokename, ballType):
    ...
    fileOpen = open('C:/Users/Administrator/Documents/galariandata.csv', newline='')
    fileData = csv.reader(fileOpen)
    for row in fileData:
        for name in row:
            if name == pokename:
...
def ball(ballName):
    ...
    fileOpen = open('C:/Users/Administrator/Documents/pokeballdata.csv', newline='')
    fileData = csv.reader(fileOpen)
    for row in fileData:
        for name in row:
            if name == ballName:
...
def dennumber(dennum):
    ...
    fileOpen = open('C:/Users/Administrator/Documents/NumDen.csv', newline='')
    fileData = csv.reader(fileOpen)
    for row in fileData:
        for Den in row:
            if Den == dennum:
...
def denname(dennamez):
    ...
    fileOpen = open('C:/Users/Administrator/Documents/Denpokename.csv', newline='')
    fileData = csv.reader(fileOpen)
    for row in fileData:
        for Name in row:
            if Name == dennamez:
